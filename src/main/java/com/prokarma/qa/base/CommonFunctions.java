...
public class CommonFunctions  extends BaseClass {
	...
	public void waitForPageToLoad(WebDriver driver,int timeSeconds) {
...
//				+ "mouseEventObj.initEvent( 'mouseover', true, true );" + "element.dispatchEvent(mouseEventObj);";
	...
	public void takeScreenShot(WebDriver driver,String screenShotName, String testName) {
		try {
			File file = new File(System.getProperty("user.dir")+File.separator+"Reports"+ File.separator +"Screenshots");
			if (!file.exists()) {
//				Log.info("File created " + file);
			...
			File targetFile = new File(System.getProperty("user.dir")+File.separator+"Reports"+ File.separator +"Screenshots"+File.separator+screenShotName+"_"+Currenttime+".png");
